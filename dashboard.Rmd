...
quiz(
  ...
  question("c. Was kommt in die Lücke *c)* rein?",
           answer("Sandwich: 49.1%"),
           answer("Sandwich: 39.9%", correct = TRUE),
           answer("Heiße Schokolade: 60.1%"),
           answer("Heiße Schokolade: 50.9%"),
           allow_retry = TRUE),
  question("d. Was kommt in die Lücke *d)* rein?",
           answer("49.1"),
           answer("50.9", correct = TRUE),
           answer("49.2"),
           answer("50.8"),
           allow_retry = TRUE)
)
...
```{r fig16, echo=FALSE, out.width = "100%"}
