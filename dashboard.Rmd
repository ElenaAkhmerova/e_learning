...
```{r fig3, echo = FALSE, out.width = "100%", fig.cap = "Auf dieser Grafik werden die Verteilung nach Alter und die Überlebungsquote gezeigt."}
...
quiz(caption = "",
     question("Was soll laut der Beschreibung oben in den Lücken stehen?",
              answer("1 - Erwachsene/r, 2 - Nicht Überlebt, 3 - Überlebt"),
              answer("1 - Erwachsene/r, 2 - Überlebt, 3 - Nicht Überlebt", 
                     correct = TRUE),
              answer("1 - Nicht Überlebt, 2 - Erwachsene/r, 3 - Überlebt"),
              answer("1 - Überlebt, 2 - Nicht Überlebt, 3 - Erwachsene/r"),
              allow_retry = TRUE))
```
