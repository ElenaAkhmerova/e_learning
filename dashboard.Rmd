...
Im Mosaikplot wird eine rechteckige Fläche in Rechtecke aufgeteilt. Die Größe dieser Rechtecke ist proportional zur relativen Häufigkeit der entsprechenden Kategorie. Die größeren Rechtecke des Mosaikplots werden in Segmente unterteilt, die die Kategorien der beiden Variablen darstellen. Damit zusätzliche Informationen noch anschaulicher sind, können die Segmente farblich markiert oder schattiert werden.
...
## Quiz
Teste jetzt deine Kenntnisse! Hier findest du 5 kurze Verständnisfragen und im nächsten Abschnitt **Programmieraufgaben** kannst du dann deine praktischen Fähigkeiten unter Beweis stellen.
...
2) Interpretationsfrage zu einem H/baum 

```{r calculations-2, exercise=TRUE}
# Hier kannst du mithilfe von R alle notwendigen Berechnungen durchführen
# ...

```

3) Interpretationsfrage zu einem Mosaikplot / erzeugen lassen
