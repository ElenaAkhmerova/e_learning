...
Im Abschnitt **Häufigkeitsbäume erstellen** hast du die Häufigkeitsverteilung nach Alter untersucht und die Beschriftungen vervollständigt. Wie wäre es nun mit einem entsprechenden Mosaikplot?
...
mosaic_dt <- data.table(Item = c(paste0("Kaffee: ", anteil_kaffee_arbeitstag, "%"), 
                                 paste0("Kaffee: ", anteil_kaffee_wochenende, "%"),
