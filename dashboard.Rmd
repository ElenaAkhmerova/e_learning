...
Führe den Code unten aus, um mehr über die Tabelle zu erfahren, die wir des Weiteren benutzen werden.
...
```{r fig2, echo = FALSE, out.width = "100%", fig.cap = "Hier sieht man schon die Verteilung nach Geschlecht und dann die Überlebungsquote."}
...
```{r fig5, echo = FALSE, out.width = "100%", fig.cap = "Auf dieser Grafik wird wieder die Verteilung nach Passagierklasse und die Überlebungsquote gezeigt, aber diesmal ohne einige Angaben zu Häufigkeiten. Kannst du die Lücken ausfüllen ohne zum Abschnitt 'Häufigkeitsbäume' zu gehen?"}
knitr::include_graphics("images/class_gaps.png")                                 # Cheating verhindern!
```
