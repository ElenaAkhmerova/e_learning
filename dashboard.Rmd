...
shiny::tabsetPanel(
  ...
  shiny::tabPanel(
    ...
    htmltools::HTML("
      ...
      <img src='images/bread_cake_weekday.png'>
...
quiz(
  ...
  question("Was ist die Wurzel?",
           ...
           allow_retry = TRUE),
  question("Gehen wir weiter zu den Knoten. Wie heißen diese?",
...
quiz(
  caption = "",
  question("35,2% der Passagiere waren Frauen. Wie viel Prozent der Passagiere waren Männer?",
           answer("65,8%"),
           answer("70%"),
  ...
  question("Und was für eine Häufigkeit ist das?",
           ...
           allow_retry = TRUE),
  question("Schaue dir jetzt die Beschriftungen der unteren Ästen an. Achte auf den Weg, über den man zum jeweiligen Endpunkt kommt. Welcher Anteil der Frauen hat überlebt?",
           answer("25,8%"),
  ...
  question("Und welcher Anteil der Passagiere ist gestorben, wenn sie Frauen waren?",
           ...
           answer("81,1%"),
           allow_retry = TRUE),
  question("Welcher Anteil der Passagiere hat überlebt, unter der Bedingung dass sie Männer waren?",
           answer("25,8%"),
           answer("74,2%"),
...
Von den 891 Passagieren und Schiffsleuten waren 164 (18,4%) unter 20 Jahren und 727 (81,6%) 20 Jahre alt oder älter. Von der ersten Gruppe haben 48,2% (79 Menschen) überlebt und entsprechend sind 51,8% (85) ums Leben gekommen. Und von den Erwachsenen sind 53,4% (388) am Leben geblieben und 46,6% (339) gestorben. Also hatten die jüngeren Menschen anscheinend fast die gleichen Überlebenschancen wie die älteren, zumindest wenn man die Altersgrenze bei 20 setzt.
...
Schaue dir ein folgendes Mosaikplot an und probiere, auf die folgenden Fragen zu antworten.
...
```{r fig11, echo = FALSE, out.width = "100%", fig.cap = "Lösungserklärung"}
...
```{r fig12, echo = FALSE, out.width = "100%", fig.cap = "Auf dieser Grafik wird wieder die Verteilung nach Geschlecht und die Überlebungsquote gezeigt, aber diesmal ohne einige Angaben zu Häufigkeiten. Kannst du die Lücken ausfüllen?"}
...
```{r fig13, echo = FALSE, out.width = "100%", fig.cap = "Lösungserklärung"}
knitr::include_graphics("images/sex_treemap.png")
```
...
```{r fig14, echo = FALSE, out.width = "100%", fig.cap = "(1) Häufigkeitsbaum"}
knitr::include_graphics("images/item_weekday_tree.png")
```

```{r fig15, echo = FALSE, out.width = "100%", fig.cap = "(2) Mosaikdiagramm"}
...
quiz(
  ...
  question(paste0("Schaue dir den obigen Häufigkeitsbaum (1) und das Mosaikdiagramm (2) an, ",
           ...
           antwort("Sandwich: 60.1%"),
           antwort("Sandwich: 49.1%"),
           antwort("Heiße Schokolade: 60.1%", correct = TRUE),
           antwort("Heiße Schokolade: 50.9%"),
           allow_retry = TRUE),
  question("b. Was kommt in die Lücke *b)* rein?",
           antwort("49.1", correct = TRUE),
           antwort("50.9"),
           antwort("49.2"),
           antwort("50.8"),
           allow_retry = TRUE),
  question("c. Was kommt in die Lücke *c)* rein?",
           antwort("Sandwich: 49.1%"),
           antwort("Sandwich: 39.9%", correct = TRUE),
           antwort("Heiße Schokolade: 60.1%"),
           antwort("Heiße Schokolade: 50.9%"),
           allow_retry = TRUE),
  question("d. Was kommt in die Lücke *d)* rein?",
           antwort("49.1"),
           antwort("50.9", correct = TRUE),
           antwort("49.2"),
           antwort("50.8"),
           allow_retry = TRUE)
)
...
**Zwischen 2016 und 2017 wurden in der Bäckerei 1025 Kuchen und 3325 Brote verkauft. 40.29% der Kuchen wurde am Wochenende verkauft und 2092 Brote haben die Kund/innen an Arbeitstagen gekauft. Wie sehen die relativen Häufigkeiten beider Produkte aus unter der Bedingung, dass sie an einem bestimmten Wochentag verkauft wurden? Beachte, dass du nur 2 Summen bilden musst, die 2 anderen sind als Platzhalter da.**
