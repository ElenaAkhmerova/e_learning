...
!!! Wie schon im vorherigen Abschnitt angedeutet ... - Lesen und interpretieren.
Aufgaben
...
Von den 891 Passagieren und Schiffsleuten waren ... (...%) unter 20 Jahren und ... (... %) 20 Jahre alt oder älter. Von der ersten Gruppen haben ...% (... Menschen) überlebt und entsprechend sind ...% (...) ums Leben gekommen. Und von den Erwachsenen sind ...% (...) am Leben geblieben und ...% (...) gestorben.
...
.
.
```{r fig4, echo = FALSE, out.width = "100%", fig.cap = "An den Ästen wurden schon die Prozentwerte geschrieben. ...% aller Menschen waren unter 20 und ...% Erwachsene, deswegen soll im Kasten links \"Kind\" und im Kasten rechts \"Erwachsene/r\" stehen. Und von den Erwachsenen sind ...% gestorben und ...% wurden gerettet. Von daher soll unten links \"Überlebt\" und unten rechts \"Nicht Überlebt\" stehen."}
knitr::include_graphics("images/age_tree.png")
```

In dieser Übung wurden nicht alle Knoten beschriftet. Wie wäre es, wenn nicht alle Prozentwerte bei den Ästen angegeben werden? Nehmen wir dafür die Überlebensquote unter der Bedindung, dass die Person in der 1., 2. oder 3. Klasse Passagier war oder zum Team gehörte, als Beispiel.

Die Häufigkeitsverteilung hinsichtlich der Passagierklasse sah so aus:
- ... Menschen (...%) waren in der 1. Klasse (... (...%) haben überlebt und ... (...%) nicht)
- ... Menschen (...%) waren in der 2. Klasse (... (...%) haben überlebt und ... (...%) nicht)
- ... Menschen (...%) waren in der 3. Klasse (... (...%) haben überlebt und ... (...%) nicht)
- ... Menschen (...%) waren Schiffsleute (... (...%) haben überlebt und ... (...%) nicht)

```{r fig5, echo = FALSE, out.width = "100%", fig.cap = "Auf dieser Grafik sieht man, wie sich alle Menschen auf Titanic in die Kategorien nach der Passagierklasse verteilt haben und welcher Prozent von der jeweiligen Kategorie überlebt oder nicht überlebt hat, aber diesmal fehlen einige Angaben zu Häufigkeiten. Kannst du die Lücken ausfüllen?"}
knitr::include_graphics("images/class_treemap_gaps.png")
```

```{r fig6, echo = FALSE, out.width = "100%", fig.cap = "Lösungserklärung"}
knitr::include_graphics("images/class_treemap.png")                                # aufklappbar machen
```
